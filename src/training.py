...
# def train_RNN_OLD(dataset, train_loader, test_loader, NUM_EPOCHS, LEARNING_RATE, saveRNN=False, plot_training_results = False, RNN_ID = None, attention_mechanism = "normal", FCCDonly = False):
...
def train_RNN_NEW(dataset, train_loader, test_loader, NUM_EPOCHS, LEARNING_RATE, 
...
# def test_RNN_OLD(RNNclassifier, test_loader, RNN_ID=None, misclassified_trials_plots = False, save_results = False, 
#             train_restricted_test_fulldataset = False, FCCDonly = False, 
#             roc_curve = False, decision_thresholds=[0.5,0.5]):
